...
bot.login("NzM0MDQ2MDA3OTM1MTA3MTcz.XxMJEA.HANJgmptFJncRMyh6K2IikZ-Zog")
  ...
  message.channel.send(embed)
            ...
            bot.on("message" , function (message) {
              ...
              bot.on("message" , function (message) {
                ...
                const embed = new Discord.RichEmbed()
                .setTitle("Les liens")
                .addField("**Le serveur support de SecurityBot**", "**https://discord.gg/nyFScHB**")
                .addField("**Le lien d'invitation de SecurityBot**", "**https://discord.com/api/oauth2/authorize?client_id=734046007935107173&permissions=8&scope=bot**")
                .setFooter("Crée par Nozi")
                .setColor("RANDOM")
                message.channel.send(embed)
                }
